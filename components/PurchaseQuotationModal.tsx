...
// FIX: PurchaseQuotationItem is not an exported member of ../types.
// It is defined locally using a mapped type from PurchaseQuotation.
import { PurchaseQuotation, Supplier, Product, RequestForQuotation } from '../types';
import { PlusIcon, TrashIcon } from './Icon';

// FIX: Define PurchaseQuotationItem locally from the imported PurchaseQuotation type.
...
const PurchaseQuotationModal: React.FC<PurchaseQuotationModalProps> = ({ quotation, onClose, onSave, suppliers, products, rfqs }) => {
    ...
    const handleAddItem = () => {
        const newItem: PurchaseQuotationItem = { productId: 0, quantity: 1, unitPrice: 0, total: 0 };
